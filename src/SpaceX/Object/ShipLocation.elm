...
module SpaceX.Object.ShipLocation exposing (..)
...
{-| -}
latitude : SelectionSet (Maybe Float) SpaceX.Object.ShipLocation
latitude =
    Object.selectionForField "(Maybe Float)" "latitude" [] (Decode.float |> Decode.nullable)


{-| -}
longitude : SelectionSet (Maybe Float) SpaceX.Object.ShipLocation
longitude =
